...
Landing page (`index.html`) e Stripe do Diagnóstico prontos. Falta:

- Publicar o site (GitHub Pages) — mesma pendência de `git push` bloqueado que o Winlist teve; ver instrução em `docs/stripe-setup.md`.
- Ativar Pix na conta Stripe (só cartão liberado hoje).
- Processo real de entrega do Diagnóstico (você faz a auditoria manualmente — não há automação).
